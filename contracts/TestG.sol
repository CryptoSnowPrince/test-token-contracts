...
contract TestG is IERC20, Auth {
    ...
    // Mainnet Address
    // address constant WETH = 0x70499adEBB11Efd915E3b69E700c331778628707; // pulse
    ...
    constructor () Auth(msg.sender) {
        ...
        // router = IDEXRouter(0xDaE9dd3d1A52CfCe9d5F2fAC7fDe164D500E50f7); // pulse router address
        router = IDEXRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // goerli router address
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETHLp = amountETH.mul(lpAmount - amountToLiquify).div(amountToSwap);
        uint256 amountETHTeam = amountETH.sub(amountETHLp);

        try distributor.deposit(feeAmount.sub(lpAmount).sub(teamAmount)) {} catch {}
        lpAmount = 0;
        teamAmount = 0;
        (bool tmpSuccess,) = payable(teamFeeReceiver).call{value: amountETHTeam, gas: 30000}("");
        ...
        if(amountToLiquify > 0){
            ...
            emit AutoLiquify(amountETHLp, amountToLiquify);
        }
    }
